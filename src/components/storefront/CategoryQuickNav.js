    ...
    <div className="bg-white border-b border-warm-200/80 shadow-2xs py-3">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-3 overflow-x-auto scrollbar-hide py-1">
          <Link
            href="/products"
            className="group shrink-0 flex flex-col items-center text-center w-20 min-w-[76px]"
          >
            ...
            <span className="text-[11px] font-semibold text-warm-900 line-clamp-2 text-center leading-tight group-hover:text-warm-700">
              All Items
            </span>
          </Link>
            ...
            >
              <div className="w-14 h-14 rounded-full overflow-hidden bg-warm-100 border border-warm-200 flex items-center justify-center mb-1.5 shadow-2xs relative group-hover:scale-105 transition-transform">
                {cat.imageUrl ? (
                  ...
                  <Folder className="w-4 h-4 text-warm-400" />
                )}
              </div>
              <span className="text-[11px] font-semibold text-warm-800 line-clamp-2 text-center leading-tight break-words w-full group-hover:text-warm-900">
                {cat.name}
              </span>
            </Link>
          ))}
